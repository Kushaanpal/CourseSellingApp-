...
function Buy() {
  ...
  return (
    <>
       {error ? (
        <div className="flex justify-center items-center h-screen bg-gradient-to-r from-black to-gray-800 px-4">
        ...
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-black to-gray-800 px-4">
          <motion.div
